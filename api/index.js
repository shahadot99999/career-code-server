...
console.log("🟢 4. Environment variables loaded");
...
// ====== BASIC ROUTES (DEFINED FIRST) ======
console.log("🟢 7. Defining basic routes...");

app.get('/', (req, res) => {
  console.log("✅ / route called");
  res.send('Career Code is Cooking - DEBUG VERSION');
});
...
app.get('/test', (req, res) => {
  ...
  res.json({ 
    message: 'Test route works! - DEBUG',
    timestamp: new Date().toISOString()
  });
});

app.get('/jobs', (req, res) => {
  console.log("✅ /jobs route called - DUMMY DATA");
  console.log("Query params:", req.query);
  
  // Return dummy data immediately (no MongoDB)
  res.json([
    { 
      _id: "debug1", 
      title: "Debug Job 1", 
...
// ====== FIREBASE (COMMENTED OUT FOR DEBUG) ======
console.log("🟢 9. Skipping Firebase initialization for debug");
/*
var admin = require("firebase-admin");
...
if (process.env.FIREBASE_PRIVATE_KEY) {
  console.log("Using Firebase env vars");
  ...
  console.log("No Firebase env vars found");
}
*/

// ====== MONGODB (COMMENTED OUT FOR DEBUG) ======
console.log("🟢 10. Skipping MongoDB connection for debug");
/*
...
async function run() {
  try {
    ...
    console.log("✅ Real /real-jobs route defined");
...
console.log("🟢 11. All setup complete - Server should be running");
...
app.use((req, res, next) => {
  ...
  res.status(404).json({ 
    ...
    availableRoutes: ['/', '/health', '/test', '/jobs']
  });
});
...
console.log("🟢 12. Error handlers added");

// ====== EXPORT FOR VERCEL ======
console.log("🟢 13. Exporting app for Vercel");
module.exports = app;

// For local development only
if (require.main === module) {
  app.listen(port, () => {
    console.log(`🚀 Career Code Server (DEBUG) running on port ${port}`);
...
console.log("🟢 14. File execution complete");
