...
let jobsCollection, applicationsCollection;
...
app.get('/health', (req, res) => {
  res.json({
    ...
    mongo: jobsCollection ? 'connected' : 'connecting',
...
app.get('/test', (req, res) => {
  res.json({
    ...
    routes: ['/', '/test', '/health', '/jobs', '/applications', '/jwt']
  });
});
...
app.use((req, res, next) => {
  res.status(404).json({
    ...
    availableRoutes: ['/', '/test', '/health', '/jobs', '/applications', '/jwt']
  });
});
